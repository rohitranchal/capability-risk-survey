...
<p>The goal of this survey is to collect expert  opinions about the likelihood of a set of threats to video conferencing systems  using two different approaches. You assume that the risk estimate is performed  at the inception stage of the project; that is, before making choices  concerning the technology—e.g., operating system and programming language. You  consider that there are successful attacks that exercise the threats and the  attacker is an individual hacker—not expert though. </p>
...
<p>Attackers could be interested to  snoop on organization meetings stealthily, view documents in the meeting rooms,  or disturb the meeting schedules of the staff of the organization and their  partners. An attacker may have or acquire certain capabilities to carry out a  successful attack on VC station. We appreciate that you provide us with your  expert opinion of the likelihood of the threats that the attacker can trigger.  The steps are:</p>
<ol>
  <li>Please  use the following link to provide your opinions about the likelihood of the  threats to the system and select the scores that you believe appropriate, for  the given factors that describe the likelihood of exercising the threat. Please click <a href="threats.php">here</a>. </li>
  <li>Please  use the following link to provide your opinions about the attacker capabilities  (e.g., attacker physical access to street camera) that an attacker may have or  acquire. For each capability, please select an option corresponding to the  likelihood that an attacker may have or acquire that capability. Please click <a href="cap.php">here</a>.</li>
  <li class="Capsurvey">Please  use the following link to provide your opinions about the likelihood of the  threats to the system and select the scores that you believe appropriate, for  the given attributes that describe the likelihood of exercising the threat.  Note that in this step, we provide the capabilities related to each threat and  request survey takers to select scores for given attributes.  Please click<a href="threat_cap.php"> here</a>.</li>
</ol>
<p>
