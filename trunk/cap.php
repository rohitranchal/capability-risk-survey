...
<form action="process.php" method="post">
	<input type="hidden" name="type" value="capabilities"/>
		...
		<tr><th style="width: 50%">Capability</th><th>Rating</th></tr>
		<tr color>
		...
		<tr>
			...
			<td>
				<table cellpadding="10">
					<tr>
						<td><label for="c2_0">Impossible</label></td>
						<td><label for="c2_1">Very Unlikely</label></td>
						<td><label for="c2_2">Likely</label></td>
						<td><label for="c2_3">Possobly</label></td>
						<td><label for="c2_4">Highly Likely</label></td>
						<td><label for="c2_5">Certain/Sure</label></td>
					</tr>
					<tr>
		...
		<tr>
			...
			<td>
				<table cellpadding="10">
					<tr>
						<td><label for="c3_0">Impossible</label></td>
						<td><label for="c3_1">Very Unlikely</label></td>
						<td><label for="c3_2">Likely</label></td>
						<td><label for="c3_3">Possobly</label></td>
						<td><label for="c3_4">Highly Likely</label></td>
						<td><label for="c3_5">Certain/Sure</label></td>
					</tr>
					<tr>
		...
		<tr>
			...
			<td>
				<table cellpadding="10">
					<tr>
						<td><label for="c4_0">Impossible</label></td>
						<td><label for="c4_1">Very Unlikely</label></td>
						<td><label for="c4_2">Likely</label></td>
						<td><label for="c4_3">Possobly</label></td>
						<td><label for="c4_4">Highly Likely</label></td>
						<td><label for="c4_5">Certain/Sure</label></td>
					</tr>
					<tr>
		...
		<tr>
			...
			<td>
				<table cellpadding="10">
					<tr>
						<td><label for="c5_0">Impossible</label></td>
						<td><label for="c5_1">Very Unlikely</label></td>
						<td><label for="c5_2">Likely</label></td>
						<td><label for="c5_3">Possobly</label></td>
						<td><label for="c5_4">Highly Likely</label></td>
						<td><label for="c5_5">Certain/Sure</label></td>
					</tr>
					<tr>
		...
		<tr>
			...
			<td>
				<table cellpadding="10">
					<tr>
						<td><label for="c6_0">Impossible</label></td>
						<td><label for="c6_1">Very Unlikely</label></td>
						<td><label for="c6_2">Likely</label></td>
						<td><label for="c6_3">Possobly</label></td>
						<td><label for="c6_4">Highly Likely</label></td>
						<td><label for="c6_5">Certain/Sure</label></td>
					</tr>
					<tr>
